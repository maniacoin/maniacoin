...
#if defined(NDEBUG)
# error "Maniacoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Maniacoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MNAC additional fees, %d delta bytes\n",
