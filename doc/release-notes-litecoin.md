Maniacoin Core version *0.15.1* is now available from:

  <https://download.maniacoin.org/maniacoin-0.15.1/>
...
A number of changes to the way Maniacoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 millimaniacs per kB (0.00001 MNAC). This is to prepare for dropping the minimum transaction fee to 0.1 millimaniacs per kB (0.0001 MNAC) in the next release.
