...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s maniacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  maniacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded maniacoin transaction") + "\n" +
              "  maniacoin-tx [options] -create [commands]   " + _("Create hex-encoded maniacoin transaction") + "\n" +
              "\n";
