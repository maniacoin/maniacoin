...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/maniacoin-project/maniacoin>";
    const std::string URL_WEBSITE = "<https://maniacoin.org>";
