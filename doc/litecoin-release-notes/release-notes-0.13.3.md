Maniacoin Core version 0.13.3 is now available from:

  <https://download.maniacoin.org/maniacoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/maniacoin-project/maniacoin/blob/0.13/src/chainparams.cpp#L214).
